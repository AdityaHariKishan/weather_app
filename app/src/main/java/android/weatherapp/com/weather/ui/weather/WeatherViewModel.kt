...
@Inject constructor(
    ...
    suspend fun getWeatherByCityCountryCode(cityName: String, countryCode: String) {
        weatherRepository.getWeatherByCityNameCountryCode(cityName, countryCode).collect { result ->
            singleWeather_.postValue(result)
        }
    }
}
